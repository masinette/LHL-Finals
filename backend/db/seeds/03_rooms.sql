INSERT INTO
rooms(user_id, latitude, longitude, title, description, roomSize, startDate, endDate, price, isPetFriendly, active, address, city_id)
VALUES
...
INSERT INTO 
rooms( user_id, title, description, latitude, longitude, roomSize, startDate, endDate, price, isPetFriendly, active, address, city_id )
VALUES
